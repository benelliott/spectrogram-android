...
public class Spectrogram {
	...
	public Spectrogram(String filepath, boolean inColour) {
		...
		while(true) {
			try {
				...
				for (int j = 0; j < elements; j++) {
					...
					toAdd[elements-j-1] = colours[val]; //needs to be 'upside down' because of where y=0 is in graphics packages
				}
